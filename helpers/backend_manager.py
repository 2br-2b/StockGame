...
class Backend:
    ...
    def _reformat_sqlite(self, data:list, custom_keys:dict|None=None): # Reformat data from the database into more friendly 
    ...
    def add_user(self, user_id:int, display_name:str | None=None, permissions:int = 210):
        """Create a game user
    ...
    def update_user(self, user_id:int, display_name:str|None=None, permissions:str|None=None): 
    ...
    def add_game(self, user_id:int, name:str, start_date:str, end_date:str|None=None, starting_money:float=10000.00, pick_date:str|None=None, private_game:bool=False, total_picks:int=10, draft_mode:bool=False, sell_during_game:bool=False, update_frequency:str='daily'):
    ...
    def add_stock_price(self, ticker:str, price:float, date:str|None=None): #TODO IF date is none use today #TODO maybe use stock_ids here? #TODO this won't handle the different game types 
    ...
    def list_stock_prices(self, stock_id:str|None=None, date:str|None=None,): # List stock prices, allow some filtering 
        """List stock prices.
    ...
    def list_stock_picks(self, status:str|None=None, participant_id:int=None): 
    ...
    def update_stock_pick(self, pick_id:int, current_value:float,  shares:int=None, start_value:float=None,  status:str|None=None): #Update a single stock pick
        items = {'shares': shares,
    ...
    def list_game_members(self, game_id: int | None = None, user_id: int | None = None, status: str | None = None):
